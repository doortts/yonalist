...
pub(crate) fn apply_image_atom_paste_with_prunes(
    ...
    // Image atom paste/edit keep the full workspace on the wire: the frontend
    // recomputes the affected root's subtree digest, which the delta cannot
    // reconstruct (Track T2).
