...
- [x] **Step 2: Add failing Rust migration and scope tests**
...
- [x] **Step 3: Extend the schema transactionally**
...
- [x] **Step 4: Implement root-only Archive operations**
...
- [x] **Step 5: Update all workspace queries**
...
- [x] **Step 1: Add failing pure history tests**
...
- [x] **Step 2: Add failing repository journal tests**
...
- [x] **Step 3: Implement row-change capture**
...
- [x] **Step 4: Implement bounded session stacks**
...
- [x] **Step 5: Integrate the coordinator**
...
- [x] **Step 6: Add keyboard integration tests**
...
- [x] **Step 2: Implement the composer through the existing action**
...
- [x] **Step 3: Move action triggers to the left rail**
...
- [x] **Step 4: Strengthen collapsed-parent styling**
...
- [x] **Step 5: Verify focused UI tests and build**
...
- [x] **Step 1: Add failing library-row and integration tests**
...
- [x] **Step 2: Implement Archive actions through the coordinator**
...
- [x] **Step 3: Implement library row and Archive view**
...
- [x] **Step 4: Run focused tests and full Notes UI tests**
...
- [x] **Step 1: Add failing tokenizer tests**
...
- [x] **Step 2: Implement a pure tokenizer and display component**
...
- [x] **Step 3: Add failing repository query tests**
...
- [x] **Step 4: Implement structured SQL queries**
...
- [x] **Step 5: Integrate filter chips and location restoration**
...
- [x] **Step 6: Verify frontend and Rust tests**
...
- [x] **Step 2: Add failing picker interaction tests**
...
- [x] **Step 3: Implement parser and picker**
...
- [x] **Step 4: Add and implement date index tests**
...
- [x] **Step 5: Integrate display pills, search, export, and Undo**
...
- [x] **Step 1: Add failing Rust validation tests**
...
- [x] **Step 2: Implement owned asset import**
...
- [x] **Step 4: Implement byte loading and image component**
...
- [x] **Step 5: Integrate history and Empty Trash cleanup**
...
- [x] **Step 1: Add failing Markdown export tests**
...
- [x] **Step 2: Add failing PDF export tests**
...
- [x] **Step 3: Implement export snapshot attachments**
...
- [x] **Step 4: Implement atomic Markdown asset output and PDF embedding**
...
- [x] **Step 1: Add integrated frontend workflows**
...
- [x] **Step 2: Add native and frontend performance probes**
...
- [x] **Step 4: Run visual and accessibility verification**
...
- [x] **Step 5: Run independent adversarial reviews**
...
- [x] **Step 6: Write final report and commit**
