...
- render the non-interactive lock then `ExternalLink` in a 0px inline cluster immediately after the displayed title; a long title shrinks/ellipsizes before the cluster, and the cluster never pins to the pane edge
