...
- [x] **Step 1: Write the failing bounded-lifetime test**
...
- [x] **Step 3: Implement the bounded harness**
...
- [x] **Step 4: Gate the virtual module with an explicit query**
...
- [x] **Step 5: Verify GREEN and the production graph**
...
- [x] **Step 3: Implement the runtime module and loader**
...
- [x] **Step 4: Route every runtime consumer through the loader**
...
- [x] **Step 5: Verify GREEN and load-boundary regression tests**
...
- [x] **Step 1: Write a failing manifest-attribution test**
...
- [x] **Step 3: Implement manifest attribution**
...
- [x] **Step 4: Audit public ESM imports**
...
- [x] **Step 5: Verify the graph and capability suite**
...
- [x] **Step 1: Write failing session lifetime tests**
...
- [x] **Step 3: Implement O(1) getters and counters**
...
- [x] **Step 4: Add pane lifetime counters and tests**
...
- [x] **Step 5: Verify GREEN and repeated lifecycle stability**
...
- [x] **Step 1: Write failing pure range tests**
...
- [x] **Step 2: Run the range test and verify RED**
...
- [x] **Step 3: Implement the pure range and pane collection**
...
- [x] **Step 4: Remove session-global visual decoration ownership**
...
- [x] **Step 5: Prove split, scroll, hit testing, and disposal**
...
- [x] **Step 6: Run focused and owning tests**
...
- [x] **Step 1: Start a fresh isolated preview**
...
Partial: two complete 31-sample runs were recorded in one warm Vite process,
but each run used a freshly loaded editor. The same-editor re-arm requirement
remains open and is called out in the evidence report.

- [x] **Step 3: Measure readiness and Workflowy directionally**
...
- [x] **Step 4: Measure bundle output**
...
- [x] **Step 5: Run final frontend gates once**
...
- [x] **Step 6: Review the frozen diff**
...
- [x] **Step 7: Update evidence and commit Task 6**
