...
- [x] **Step 1: Add failing TypeScript validator tests**
...
- [x] **Step 2: Run the domain tests and verify the expected failure**

Run: `npm test -- src/domain/notes.test.ts`

Expected: FAIL because `NoteNode` and `isNoteNode` do not know `nodeKind`.

- [x] **Step 3: Add failing Rust migration and serialization tests**
...
- [x] **Step 4: Run the focused Rust tests and verify the expected failure**
...
- [x] **Step 5: Implement the smallest complete kind contract**
...
- [x] **Step 1: Add failing domain and raw-envelope tests**
...
- [x] **Step 2: Verify raw and store tests fail for missing APIs**
...
- [x] **Step 3: Add failing Rust success, rollback, and history tests**
...
- [x] **Step 4: Run focused Rust tests and verify feature-missing failures**
...
- [x] **Step 5: Implement shared preparation and one transaction**
...
- [x] **Step 6: Implement TypeScript invocation and response validation**
...
- [x] **Step 1: Add failing pure placement tests**
...
- [x] **Step 3: Add failing hook and integration tests**
...
- [x] **Step 4: Verify the integration tests fail for old attachment calls**
...
- [x] **Step 5: Implement routing without changing drag visuals**
...
- [x] **Step 1: Add failing row and page-header rendering tests**
...
- [x] **Step 2: Add failing keyboard tests**
...
- [x] **Step 3: Run focused tests and verify old rendering fails**
...
- [x] **Step 4: Implement kind-aware primary content**
...
- [x] **Step 5: Implement image description focus**
...
- [x] **Step 6: Run Task 4 suites and memoization tests**
...
- [x] **Step 1: Add failing menu and lightbox tests**
...
- [x] **Step 2: Add failing delete-semantics tests**
...
- [x] **Step 3: Add failing backend path-security tests**
...
- [x] **Step 4: Run focused tests and verify missing-action failures**
...
- [x] **Step 5: Implement menu and lightbox**
...
- [x] **Step 6: Implement validated original and download commands**
...
- [x] **Step 1: Add failing navigation and settings tests**
...
- [x] **Step 3: Implement typed navigation and one-shot target consumption**
...
- [x] **Step 1: Add failing export and search tests**
...
- [x] **Step 2: Add failing lifecycle and performance tests**
...
- [x] **Step 3: Run focused suites and verify kind-aware failures**
...
- [x] **Step 4: Implement minimal kind-aware export and lifecycle fixes**
...
- [x] **Step 6: Run functional and visual verification**
...
- [x] **Step 7: Run performance verification**
...
- [x] **Step 8: Perform adversarial whole-change review**
