...
> **중간 정산**: 진행 상황, 이 계획에서 실제로 바뀐 것, 그리고 여덟 라운드의
> 적대적 리뷰가 남긴 교훈은 [2026-08-16-sync-progress-and-lessons.md](2026-08-16-sync-progress-and-lessons.md)에
> 있다. 남은 항목을 집기 전에 그 문서의 §3·§4를 먼저 읽는다.
