...
- [ ] **Step 1: Add failing TypeScript wire-contract tests**
...
- [ ] **Step 2: Run the TypeScript contract tests and verify RED**
...
- [ ] **Step 3: Add failing Rust wire and oversized-history tests**
...
- [ ] **Step 5: Implement the shared typed contract and boundary validation**
...
- [ ] **Step 6: Make history finalization reject an oversized new entry atomically**
...
- [ ] **Step 7: Run focused GREEN and nearby regressions**
...
- [ ] **Step 1: Add failing repository duplicate tests**
...
- [ ] **Step 2: Add failing attachment-capacity tests for single and batch duplicate**
...
- [ ] **Step 4: Extract one transaction-level forest-copy helper**
...
- [ ] **Step 5: Add failing command/history tests**
...
- [ ] **Step 7: Wire duplicate through the dated batch command path**
...
- [ ] **Step 8: Run focused GREEN and all existing duplicate regressions**
...
- [ ] **Step 1: Add failing byte-safe tag span/removal tests**
...
- [ ] **Step 2: Run tokenizer/helper tests and verify RED**
...
- [ ] **Step 3: Implement canonical tag mutation helpers**
...
- [ ] **Step 4: Add failing repository/command/history tests**
...
- [ ] **Step 5: Run repository/command tests and verify RED**
...
- [ ] **Step 6: Implement dated atomic tag batches**
...
- [ ] **Step 7: Run focused GREEN and tag/date/search regressions**
...
- [ ] **Step 1: Add failing table-driven selection-model tests**
...
- [ ] **Step 2: Run selection-model tests and verify RED**
...
- [ ] **Step 3: Implement the pure immutable model**
...
- [ ] **Step 4: Add failing keyboard and move-target tests**
...
- [ ] **Step 5: Run keyboard/move tests and verify RED**
...
- [ ] **Step 6: Route keyboard facts to semantic intents**
...
- [ ] **Step 7: Run focused GREEN and pure outline regressions**
...
- [ ] **Step 1: Add failing serializer and round-trip tests**
...
- [ ] **Step 3: Implement the pure outline format and parser extension**
...
- [ ] **Step 4: Add failing clipboard adapter tests**
...
- [ ] **Step 6: Implement injected clipboard adapters**
...
- [ ] **Step 7: Run focused GREEN and paste/image regressions**
...
- [ ] **Step 1: Add failing workspace command-contract tests**
...
- [ ] **Step 3: Add failing selection-lifecycle tests**
...
- [ ] **Step 4: Extend coordinator/workspace policy plumbing**
...
- [ ] **Step 5: Add failing frozen-ownership and Cut ordering tests**
...
- [ ] **Step 6: Implement the pane-owned semantic router**
...
- [ ] **Step 7: Run focused GREEN and coordinator regressions**
...
- [ ] **Step 1: Add failing action-bar accessibility/behavior tests**
...
- [ ] **Step 2: Add failing responsive overflow tests**
...
- [ ] **Step 3: Run action-bar tests and verify RED**
...
- [ ] **Step 4: Implement the action bar and responsive styles**
...
- [ ] **Step 5: Add failing Move To and tag chooser tests**
...
- [ ] **Step 6: Run chooser tests and verify RED**
...
- [ ] **Step 7: Implement both focused choosers**
...
- [ ] **Step 8: Run focused GREEN, accessibility, and style checks**
...
- [ ] **Step 1: Add failing parameterized entry-point parity tests**
...
- [ ] **Step 2: Add failing drag and move safety regressions**
...
- [ ] **Step 3: Run rendered parity tests and verify RED**
...
- [ ] **Step 4: Integrate the shared router and contextual UI**
...
- [ ] **Step 5: Add failing rendered clipboard/lifecycle/focus tests**
...
- [ ] **Step 6: Run the rendered tests and verify RED**
...
- [ ] **Step 7: Complete integration without duplicating semantics**
...
- [ ] **Step 8: Run focused GREEN and high-risk regressions**
...
- [ ] **Step 2: Fix every Critical and Important review finding with RED/GREEN evidence**
...
- [ ] **Step 3: Run the complete frontend verification from a clean command invocation**
...
- [ ] **Step 4: Run the complete Rust and repository verification**
...
- [ ] **Step 5: Perform the desktop and narrow manual contract pass when the app can be launched**
...
- [ ] **Step 6: Present branch-integration choices without merging automatically**
