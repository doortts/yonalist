...
- Seed: 5,000 Notes nodes, 50 roots, five consecutive empty roots
- Runtime: the app adds one reserved GitHub Notifications root, so both the
  before and after desktop runs contain 5,001 active nodes
...
longer interval. Latencies are measured from the physical keydown.

## Before

| Operation | Pane | Visible p50 / p95 | Authoritative p50 / p95 | Active commits p50 / p95 | Inactive commits p50 / p95 |
| --- | --- | ---: | ---: | ---: | ---: |
| Arrow | Primary | 25 / 33 ms | N/A | 4 / 4 | 2 / 2 |
| Arrow | Secondary | 73 / 81 ms | N/A | 5 / 5 | 2 / 2 |
| Enter, clean title | Primary | 31 / 39 ms | 300 / 415 ms | 12 / 15 | 6 / 9 |
| Enter, clean title | Secondary | 32 / 37 ms | 246 / 284 ms | 9 / 10 | 9 / 10 |
| Enter, pending title edit | Primary | 31 / 41 ms | 437 / 494 ms | 14 / 15 | 8 / 9 |
| Enter, pending title edit | Secondary | 30 / 40 ms | 434 / 508 ms | 12 / 12 | 12 / 12 |
