...
export function useNotesWorkspace({
  ...
  const {
    createRoot,
    createChild,
    createNextTextSibling, materializeGithubNotification, refreshMaterializedGithubNotifications, markMaterializedGithubNotificationRead, setGithubGroupCollapsed,
    splitNode,
